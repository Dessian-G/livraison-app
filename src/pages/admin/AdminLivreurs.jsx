  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button onClick={ouvrirNouveauLivreur} className="flex items-center gap-1 bg-orange text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-orange-dark transition">
        ...
        {livreurs.map(l => (
          <div key={l.id} className="bg-white rounded-xl shadow-sm p-4 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => ouvrirModifier(l)} className="text-gray-400 hover:text-orange transition"><Pencil size={18} /></button>
            ...
            <div className="p-5 space-y-4">
              ...
              {modal.mode === 'edit' && (
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={form.disponible} onChange={e => setForm(f => ({ ...f, disponible: e.target.checked }))} className="w-4 h-4 accent-orange" />
